...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ziad El-Sayed — Frontend Developer" },
      {
        name: "description",
        content:
          "Portfolio of Ziad El-Sayed, frontend developer building responsive, scalable React and Next.js applications.",
      },
      { name: "author", content: "Ziad El-Sayed" },
