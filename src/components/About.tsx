        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <Card className="p-8 animate-slide-up">
            <p className="text-xl md:text-2xl text-foreground/90 leading-relaxed">
              I'm a passionate Frontend Developer with expertise in TypeScript,
              React, JavaScript (ES6+), React Query, Tailwind CSS, Redux,
              Shadcn, and RESTful APIs. Familiar with Node.js, Express, MySQL
              and MongoDB for Full-stack integration.
            </p>
            <p className="text-xl md:text-2xl text-foreground/90 leading-relaxed">
              Enthusiastic about teaching, mentoring, and contributing to the
              tech community, while staying committed to continuous learning and
              modern technologies. Skilled in building responsive, accessible,
              and scalable applications with strong focus on state management,
